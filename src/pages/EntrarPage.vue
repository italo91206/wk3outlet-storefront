      ...
      <div class="row flex">
        <form @submit.prevent="login" class="col-4 m-0-auto">
          ...
          <div class="form-group w100">
            <button class="w100">Entrar</button>
          </div>
      ...
      <div class="row flex">
        <form @submit.prevent="cadastro" class="col-4 m-0-auto">
          <div class="form-group">
            ...
            <input type="text" placeholder="Primeiro nome" v-model="perfilToPost.nome"/>
          </div>

          <div class="form-group">
            <label for="">Sobrenome</label>
            <input type="text" placeholder="Último nome" v-model="perfilToPost.sobrenome"/>
          </div>

          <div class="form-group">
            <label for="">E-mail</label>
            <input type="text" placeholder="Seu e-mail" v-model="perfilToPost.email"/>
          </div>

          <div class="form-group form-group--radio">
            <input type="radio" id="tipo_pessoa_pf" value="pf" v-model="tipo_pessoa">
            <label for="">Pessoa física</label>
          </div>

          <div class="form-group form-group--radio">
            <input type="radio" id="tipo_pessoa_pj" value="pj" v-model="tipo_pessoa">
          ...
          <div v-if="tipo_pessoa == 'pf'">
            <div class="form-group">
              <label for="">RG</label>
              <input type="text" placeholder="Seu rg" v-model="perfilToPost.rg">
            </div>

            <div class="form-group">
              <label for="">CPF</label>
              <input type="text" placeholder="Seu CFP" v-model="perfilToPost.cpf">
            </div>
          </div>
          ...
          <div v-else>
            <div class="form-group">
              ...
              <input type="text" placeholder="Seu CNPJ" v-model="perfilToPost.cnpj">
            </div>

            <div class="form-group">
              <label for="">Nome Fantasia</label>
              <input type="text" name="" placeholder="Nome fantasia da empresa" v-model="perfilToPost.nFantasia">
            </div>

            <div class="form-group">
              <label for="">Razão Social</label>
              <input type="text" placeholder="Razão social da empresa" v-model="perfilToPost.razaoSocial">
            </div>
          </div>
...
export default {
  ...
  methods: {
    async login(){
      ...
      await login_service.fazerLogin({email, password})
        .then((response) => {
    ...
    async cadastrar(){
      await usuario_service.novoUsuario(this.perfilToPost)
        .then((response) => {
          if(response.data.success){
  ...
  watch: {
    tipo_pessoa(){
      if(this.tipo_pessoa == 'pf')
        this.perfilToPost.isCompany = false;
      else
        this.perfilToPost.isCompany = true;
    }
  }
};
</script>
